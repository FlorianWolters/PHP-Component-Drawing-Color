...
Contributions to **FlorianWolters\Component\Drawing\Color** are always welcome.
...
Run the following commands to initially checkout **FlorianWolters\Component\Drawing\Color**:

    md Color && cd Color
    git clone git://github.com/FlorianWolters/PHP-Component-Drawing-Color.git
